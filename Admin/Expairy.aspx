<%@ page title="" language="C#" masterpagefile="~/Admin/MasterPage.master" autoeventwireup="true" inherits="Admin_Expairy, App_Web_uqpvsrqs" %>
            ...
            <div>
						<div class="order-message">
							...
							<asp:DropDownList ID="DDPid" runat="server" Width="100%" Visible="True">
                                    ...
                                    <asp:Button ID="btnAllow" runat="server" CssClass="btn btn-primary" Text="Renew" OnClick="btnAllow_click"></asp:Button>
                                    <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-primary" Text="Remove" OnClick="btnDelete_click"></asp:Button>
						</div>	
			</div>	
